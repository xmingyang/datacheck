...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `proj_sql`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `proj_sql` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int(11) unsigned NOT NULL default 0,
  `sql_text` text NOT NULL ,
  `sql_cn` varchar(100) DEFAULT NULL,
  `level` int(11) unsigned NOT NULL default 0 comment '0一般 1重要 2紧急',
  `priority` int(11) unsigned DEFAULT 0 ,
  `owner` varchar(50) DEFAULT NULL,
  `datasource_id` int(11) unsigned NOT NULL default 0,
...
DROP TABLE IF EXISTS `proj_sql_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;

CREATE TABLE `proj_sql_import` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int(11) unsigned NOT NULL default 0,
  `sql_text` text,
  `sql_cn` varchar(50) DEFAULT NULL,
  `level` int(11) unsigned NOT NULL default 0 comment '0一般 1重要 2紧急',
  `priority` int(11) unsigned DEFAULT '0',
  `owner` varchar(50) DEFAULT NULL,
  `module` varchar(50) DEFAULT NULL,
...
CREATE TABLE `proj_log` (
  ...
  `sql_id` int(11) unsigned NOT NULL default 0,
  `sql_cn` varchar(100) DEFAULT NULL,
  `is_hasdata` int(11) unsigned NOT NULL default 0 comment 'sql是否跑出数据',
...
CREATE TABLE `datasource` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  dbtype varchar(20)  NOT NULL comment '数据库类型greenplum、mysql',
